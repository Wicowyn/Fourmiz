 ...
 * Cette classe permet d'afficher le menu ainsi que l'arri�re plan de l'interface (/image/wallpaper.png)
 */
public class MenuState extends BasicGameState implements LayoutMenuActionListener{
	...
	/**
	 * Action en fonction de l'�l�ment s�lectionn� dans le menu principale
	 */
	@Override
